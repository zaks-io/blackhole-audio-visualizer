 ...
 * - system: false = user/preset controls
...
export interface ParameterDef {
  ...
  group: string;
  label: string;
  system: boolean; // true = dev-only, false = user/preset
}
...
export const PARAMS: Record<string, ParameterDef> = {
  ...
  "Emitters.emitterSpread": {
    ...
    default: 0.1,
    step: 0.05,
    description: "emission angle: 0=tight stream, 1=wide fan",
    group: "Emitters",
    label: "Spread",
    system: false,
  },
  "Emitters.emitterWidth": {
    min: 0,
    max: 2,
    default: 0.1,
    step: 0.05,
    description: "emitter size: 0=point source, higher=wider emitter",
    group: "Emitters",
    label: "Width",
    system: false,
  },
  ...
  "Audio.beatMassPulse": {
    ...
    group: "Audio",
    label: "Beat Mass Pulse",
    system: false,
  },
  "Audio.beatPhaseCorrection": {
    min: 0,
    max: 1,
    default: 0.5,
    step: 0.05,
    description: "phase correction strength for BPM-synced effects (0=loose, 1=tight)",
    group: "Audio",
    label: "Beat Phase Lock",
    system: true,
  },
  "Audio.beatPulse": {
    min: 0,

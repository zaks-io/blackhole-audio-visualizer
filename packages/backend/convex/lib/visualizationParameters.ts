...
export const PARAMS: Record<string, ParameterDef> = {
  ...
  "Audio.beatBounceAmplitude": {
    min: 0,
    max: 50,
    default: 2,
    step: 1,
    description: "BPM-synced vertical bounce amplitude for black holes",
    group: "Audio",
    label: "Beat Bounce",
    system: false,
  },
  "Audio.beatBouncePhaseCorrection": {
    min: 0,
    max: 1,
    default: 0.5,
    step: 0.05,
    description: "phase correction strength for beat-synced bounce (0=loose, 1=tight)",
    group: "Audio",
